...
const serviceAreas = [
  "Tampa", "St. Petersburg", "Clearwater", "Wesley Chapel",
  "Sarasota", "Lakeland", "Largo", "Brandon",
];
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <PhoneIcon />
                <a href="tel:9548186405" className="text-sm hover:text-gold transition-colors">
                  (954) 818-6405
                </a>
              </li>
              <li className="flex items-start gap-3">
                <MailIcon />
                <a href="mailto:contact@spbrenovations.com" className="text-sm hover:text-gold transition-colors">
...
function PhoneIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="shrink-0 mt-0.5 text-gold">
